...
//    private final ObjectRenderer cubeSelected = new ObjectRenderer();
    ...
    private static final int MAX_CAMERAPOSE_COUNT = 900;
    private int numCameraPose = 0;
...
//    private ArrayBlockingQueue<Float> queuedScrollDy = new ArrayBlockingQueue<>(MAX_CUBE_COUNT);
    ...
    private GLSurfaceRenderer glSurfaceRenderer = null;
...
//                        glSurfaceRenderer.setNowTouchingPointIndex(index);
//                        glSurfaceRenderer.showMoreAction();
//                    }catch (Exception e){
//                        log(e);
//                    }
//                }
...
//            }
//        });
        glSurfaceRenderer = new GLSurfaceRenderer(this);
...
//                        break;
//                    case 0:// delete
//                        glSurfaceRenderer.deleteNowSelection();
//                        popupWindow.dismiss();
//                        fab.hide();
//                        break;
//                    case 1:// set as first
//                        glSurfaceRenderer.setNowSelectionAsFirst();
//                        popupWindow.dismiss();
//                        fab.hide();
//                        break;
//                    case 2:// move horizontal axis
...
//                @Override
//                public void run() {
//                    int nowSelectIndex = glSurfaceRenderer.getNowTouchingPointIndex();
...
//        }
    ...
    private void emptyCameraAnchors() {
        numCameraPose = cameraAnchors.size();
        for (int i = numCameraPose -1; i>=0; i--) {
            cameraAnchors.remove(i).detach();
        }
        numCameraPose = 0;
        fab.hide();
    }
